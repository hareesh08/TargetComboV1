...
namespace TargetCombo_V1.security
{
    public class TrialManager
    {
        ...
        [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(System.Threading.Timer))]
        private static void StartLicenseTimer()
        {
            _licenseTimer =
                new System.Threading.Timer(_ => { DisplayRemainingTimeInTitle(); }, null, 0,
        ...
        private static void ActivateTrial()
        {
            try
            {
                ...
                if (trialData == null)
                {
                    trialData = new TrialManager.TrialData
                    {
                        Token = null,
                        LastTrialDate = null
                    };
